...
<!-- PAGE TITLE -->
			...
			<section class="container">
				...
				<ul>
					<li>excludes all representations and warranties relating to this website and its contents or which is or may be provided by any affiliates or any other third party, including in relation to any inaccuracies or omissions in this website and/or the WeePee’s literature; and </li>
				...
				<h2>Payment</h2>
				<p>Cash or Personal Check with Bankers Card, all major Credit/Debit Cards, Bankers Draft or BACS Transfer are all acceptable methods of payment. Our Terms are payment in full within thirty days. All goods remain the property of Weepee until paid for in full. Monies that remains outstanding by the due date will incur late payment interest at the rate of 2% above the prevailing Bank of America's base rate on the outstanding balance until such time as the balance is paid in full and final settlement. We reserve the right to seek recovery of any monies remaining unpaid sixty days from the date of invoice via collection Agencies and/or through the Small Claims Court in the event that the outstanding balance does not exceed $5000. In such circumstances, you shall be liable for any and all additional administrative and/or court costs. </p>
				<p>Returned checks will incur a $45 charge to cover banking fees and administrative costs. In an instance of a second Returned check, we reserve the right to terminate the arrangement and, if agreed to, we shall insist on future cash transactions only. Consequently, all bookings and/or transactions and agreements entered into will cease with immediate effect until such time as any and all outstanding monies are recovered in full.</p>

				<hr class="half-margins" /><!-- separator -->

				<h2>Cancellation Policy</h2>
				<p>Minimum 24 hours notice of cancellation required. Notification for instance, in person, via email, mobile phone ‘text message’ and/or fax, or any other means will be accepted subject to confirmation in writing. We reserve the right to levy a £30 charge to cover any subsequent administrative expenses.</p>
				...
				<p>Copyright and other relevant intellectual property rights exists on all text relating to the WeePee’s services and the full content of this website. </p>
				<p>This WeePee’s logo is a registered trademark of this WeePee LLC in the United States and other countries. The brand names and specific services of WeePee LLC featured on this web site are trade marked. </p>

				<hr class="half-margins" /><!-- separator -->

				<h2>Communication</h2>
				<p>We have several different e-mail addresses for different queries. These, & other contact information, can be found on our Contact Us link on our website or via Company literature or via the WeePee’s stated telephone, facsimile or mobile telephone numbers.</p>
				<!---<p>This company is registered in the United States, Number 11111111, registered office 123 Any Street, Anytown AB2 3CD.  [Only need to state this if Limited Company, otherwise proprietors’/partners’ home/trading address must be shown, without use of the term: registered]</p>--->
				...
				<!---<a href="http://www.entrepreneur.com/formnet/form/1174" target="_blank">Text from: <strong>Website Standard Terms and Conditions</strong></a>--->
			</section>
